...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_KeyboardDialog_t, stringdata) + ofs \
...
const QMetaObject KeyboardDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_KeyboardDialog.data,
      qt_meta_data_KeyboardDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *KeyboardDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_KeyboardDialog.stringdata))
